...
using LoadTestingApp.Blazor.Server.Services;
using DevExpress.ExpressApp.Core;

namespace LoadTestingApp.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<LoadTestingAppBlazorApplication>();
            builder.Modules
                ...
                .AddViewVariants()
                .Add<LoadTestingApp.Module.LoadTestingAppModule>()
            	.Add<LoadTestingAppBlazorModule>();
